...
const accessRuleKey = "juntendoCampusShopAccessRule-groupB";
...
function setupLoginPage() {
  ...
  form.addEventListener("submit", (event) => {
    ...
    if (id === ADMIN_ID && password === ADMIN_PASSWORD) {
      ...
      window.location.href = "groupB-admin.html";
      return;
    }
...
function requireAdminLogin() {
  ...
  if (!loggedIn) {
    window.location.replace("groupB-login.html");
    return false;
  }
  return true;
}
...
function setupLogoutButton() {
  ...
  button.addEventListener("click", () => {
    ...
    window.location.href = "groupB-login.html";
  });
}
